...
export default function DriverBlock({ countryCode, forename, surename, points, position, driverId }: any) {
    ...
    return (
        <div className="flex gap-6 justify-between items-center bg-gradient-to-r hover:dark:bg-neutral-800 from-transparent dark:to-black to-neutral-100 hover:bg-neutral-300 cursor-pointer py-2 px-4 rounded-md my-1 drop-shadow-sm" onClick={() => router.push('/driver/' + { driverId })}>
