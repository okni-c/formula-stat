    ...
    return (
        <nav className="z-[2] w-full max-w-[9rem] h-screen shadow-lg dark:bg-neutral-900 bg-white fixed">
            <div className="flex flex-col justify-start h-[100%]">
                ...
                <Link href="/" className="hover:dark:bg-zinc-300 hover:bg-zinc-200 hover:text-black dark:text-white text-black text-xl font-normal pl-6 py-4 duration-150 ease-in-out justify-end mt-auto"><span className={isActiveRoute('/settings') ? 'font-black' : ''}>Settings</span></Link>
            </div>
        </nav>
    );
}