    ...
    return (
        <section className="flex justify-between mt-28">
            <div className="flex flex-col gap-4">
                ...
                <p className="text-5xl bg-clip-text bg-gradient-to-b text-transparent from-black dark:from-white dark:to-neutral-200 to-neutral-700 font-black">Next Round - {round}</p>
                <p className="text-4xl bg-clip-text bg-gradient-to-b text-transparent from-black dark:from-white dark:to-neutral-300 to-neutral-600 font-regular">{circuitName}</p>
            </div>
