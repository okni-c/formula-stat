    ...
    return (
        <section className="flex justify-between mt-20">
            <div className="flex flex-col gap-2">
                <h1 className="text-3xl bg-clip-text bg-gradient-to-b text-transparent from-black dark:from-white dark:to-neutral-400 to-neutral-600 font-black drop-shadow-md leading-snug">2023 Season</h1>
